/*Prototype
    -when we create any custom obj then js engine internally make this obj points to Object.prototype and inside that all methods are present.
    -Object.prototype
    -Array.prototype
...
// obj.greet();
// console.log(obj.hasOwnProperty('name'));//true //how ar we able to call .hasOwnProperty() method even we have not defined in our obj1, bcz of Prototype
// console.log(obj.toString());//[object Object] // how ar we able to call .toString() method even we have not defined in our obj1

const obj2={
    amount:100,
    account_num:8409,
    __proto__:obj1, //in this way also we can make any custome obj to inherit any custom obj  //other way to do that is// obj2.__proto__=obj1;
}
